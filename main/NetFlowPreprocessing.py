...
def main():
    ...
    datasets = ["NF-CSE-CIC-IDS2018-v2/NF-CSE-CIC-IDS2018-v2-split.csv", "NF-UNSW-NB15-v2/NF-UNSW-NB15-v2.csv"]
    ...
    df = ft.load_dataset("CSE-CIC-IDS2018",
    ...
    df["Attack"] = ft.y
    print(df.shape)
    df.to_csv("data/nf-pre/NF-CSE-CIC-IDS2018-pre.csv", index=False)
