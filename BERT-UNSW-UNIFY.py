...
from customize.NetFlowUtility import NetFlowLabelEncoder, SparseCategoricalFocalLoss, NetFlowSlicing, NetFlowBatchLoader, LabelUnify
...
def main(
    ...
    loss_fn = SparseCategoricalFocalLoss(gamma=1, from_logits=False) # SparseCategoricalFocalLoss(gamma=1, alpha=alpha, from_logits=False)
